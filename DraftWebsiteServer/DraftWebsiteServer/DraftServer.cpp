...
/// <summary>
/// servern som startas fr�n main loopen 
/// </summary>
...
void DraftServer::Start(const std::string& entryPoint,std::vector<std::string> argv)
{
    ...
    //REquesten f�r att f� alla resurser som css och bilder och dylikt
    ...
    //requesten som behandlar alla pollande uppdateringar fr�n klienten. Avg�r requesten utifr�n bodyn och returnar utefter det korrosponerande json fil
    ...
    //Requesten som behandlar n�r en spelare vill se kortet de har tagit digiare
    ...
    //Requesten som behandlar n�r en spelare vill hosta en lobby
    ...
    //Requesten som behandlar n�r en spelare vill starta lobbyn. G�r bara om man �r spelaren som hostade lobbyn
   ...
   //     json messageJson = json::parse(req.body);
    ...
    //metoden n�r en spelare vill ta ett kort som �r tillg�ngligt till dom 
...
//laddar in korten f�r bilderna utifr�n en lokal resurs
...
//metoden f�r n�r man hosta en lobby
...
//of�rdig metod f�r n�r man ska ta bort en lobby
